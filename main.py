...
def manage_books():
    ...
    """
    bm = BookManager()  # Creating an instance of BookManager
...
def manage_users():
    ...
    """
    um = UserManager()  # Creating an instance of UserManager
    while True:
        print("\n1. Add user\n2. Remove user\n3. List users\n4. Back")
        choice = input("Select an option: ")
...
if __name__ == "__main__":
    main_menu()  # Starting the main menu loop when the script is run directly
